...
const JWT_SECRET = process.env.JWT_SECRET || (() => {
  console.warn('[Security] 使用默认JWT密钥，生产环境请设置JWT_SECRET环境变量');
  return 'yunsf-jwt-secret-2024-' + crypto.randomBytes(16).toString('hex');
})();
  ...
  static generateToken(payload, options = {}) {
    try {
      ...
      const enhancedPayload = {
        ...
        sessionId: crypto.randomBytes(16).toString('hex') // 会话ID
      };
